                    ...
                    <div key={item.id} className="flex items-center justify-between mb-2 hover:bg-gray-50 transition-colors duration-200">
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button variant="outline" className="w-full justify-start mr-2 py-2 px-3 shadow-md hover:shadow-lg transition-shadow duration-200">
...
export default function MyLibraryComponent({
  ...
  const [libraryItems, setLibraryItems] = useState<LibraryItem[]>([
    {
      id: 1,
      title: "Billie's Fever",
      content:
        "Billie had a fever of 101°F. Gave acetaminophen and monitored throughout the night. Fever broke by morning.",
      section: "Billie's Care Log",
      date: "2023-05-15",
      time: "20:30",
    ...
    },
    {
      ...
      title: "Billie's Rash",
      content:
        "Noticed a small rash on Billie's arm. Applied hydrocortisone cream. Will monitor for changes.",
      section: "Billie's Care Log",
      date: "2023-05-20",
      time: "10:15",
      tags: ["rash", "skin"],
    ...
    {
      id: 3,
      title: "Billie's First Steps",
      content:
        "Billie took his first steps today! He managed to walk three steps before sitting down.",
      section: "Billie's Care Log",
      date: "2023-06-01",
      time: "18:45",
    ...
    {
      id: 4,
      title: "Billie's Teething",
      content:
        "Billie seems to be teething. Gums are swollen and he's drooling more than usual. Using teething ring for relief.",
      section: "Billie's Care Log",
      date: "2023-06-10",
      time: "14:20",
      tags: ["teething", "discomfort"],
    },
    {
      id: 5,
      title: "Megan's Vaccination",
      content:
        "Megan received her MMR vaccine. No immediate side effects observed. Will monitor for the next 48 hours.",
      section: "Megan's Care Log",
      date: "2023-06-01",
      time: "14:15",
    ...
    {
      id: 6,
      title: "Megan's Allergic Reaction",
      content:
        "Megan developed a mild rash after eating strawberries. Administered antihistamine. Will avoid strawberries in the future.",
      section: "Megan's Care Log",
      date: "2023-06-15",
      time: "19:30",
      tags: ["allergy", "food"],
    ...
    {
      id: 7,
      title: "Megan's Sleep Regression",
      content:
        "Megan has been waking up multiple times at night. Trying adjusted bedtime routine to help her sleep through the night.",
      section: "Megan's Care Log",
      date: "2023-06-20",
      time: "22:00",
      tags: ["sleep", "routine"],
    ...
    {
      id: 8,
      title: "Megan's First Words",
      content:
        "Megan said her first word today: 'Mama'! She's been babbling more frequently lately.",
      section: "Megan's Care Log",
      date: "2023-06-25",
      time: "09:10",
    ...
    },
    {
      ...
      content:
        "Q&A about managing child fevers. Key points: stay hydrated, rest, when to call the doctor.",
      section: "Q&A",
      date: "2023-05-20",
      time: "10:00",
      tags: ["fever", "health tips"],
    },
    {
      id: 10,
      title: "Picky Eating Strategies",
      content:
        "Q&A session on dealing with picky eaters. Suggestions include involving kids in meal prep and offering variety.",
      section: "Q&A",
      date: "2023-06-05",
      time: "15:30",
    ...
    },
    {
      ...
      content:
        "Q&A on effective potty training methods. Discussed consistency, positive reinforcement, and patience.",
      section: "Q&A",
      date: "2023-06-18",
      time: "11:45",
      tags: ["potty training", "development"],
    },
    {
      id: 12,
      title: "Sibling Rivalry Management",
      content:
        "Q&A about managing sibling rivalry. Strategies include individual attention and promoting cooperation.",
      section: "Q&A",
      date: "2023-06-30",
      time: "14:00",
      tags: ["behavior", "siblings"],
    },
    {
      id: 13,
      title: "Sleep Training Podcast",
      content:
        "Notes from sleep training podcast episode. Discussed cry-it-out method, gradual retreat, and bedtime routines.",
      section: "Podcasts",
      date: "2023-06-10",
      time: "22:00",
      tags: ["sleep training", "podcast"],
    },
    {
      id: 14,
      title: "Nutrition for Toddlers Podcast",
      content:
        "Podcast notes on balanced diets for toddlers. Covered importance of variety, portion sizes, and dealing with food refusal.",
      section: "Podcasts",
      date: "2023-06-20",
      time: "20:30",
      tags: ["nutrition", "podcast"],
    },
    {
      id: 15,
      title: "Positive Discipline Podcast",
      content:
        "Podcast discussing positive discipline techniques. Emphasized consistency, clear communication, and natural consequences.",
      section: "Podcasts",
      date: "2023-07-01",
      time: "19:15",
      tags: ["discipline", "podcast"],
    },
    {
      id: 16,
      title: "Early Childhood Education Podcast",
      content:
        "Podcast on the importance of early childhood education. Discussed various learning styles and at-home activities.",
      section: "Podcasts",
      date: "2023-07-10",
      time: "21:00",
    ...
    {
      id: 17,
      title: "Billie's Check-up",
      content:
        "Prepare questions about Billie's recent fever and sleep patterns. Don't forget to bring vaccination records.",
      section: "Doctor's Notes",
      date: "2023-07-01",
      time: "09:30",
      tags: ["check-up", "questions"],
    },
    {
      id: 18,
      title: "Megan's Allergy Consult",
      content:
        "Appointment for Megan's allergy testing. Bring food diary and list of observed reactions.",
      section: "Doctor's Notes",
      date: "2023-07-15",
      time: "14:00",
    ...
    {
      id: 19,
      title: "Billie's Dental Visit",
      content:
        "First dental check-up for Billie. Questions about teething and proper oral care for toddlers.",
      section: "Doctor's Notes",
      date: "2023-07-20",
      time: "11:00",
    ...
    },
    {
      ...
      content:
        "Schedule flu shots for the whole family. Check if any new vaccinations are recommended.",
      section: "Doctor's Notes",
      date: "2023-08-01",
      time: "10:00",
              ...
              <ScrollArea className="h-[400px] w-full border rounded-md p-4">
                {libraryItems
                  ...
                  .map((item) => (
                    <div
                      key={item.id}
                      className="flex items-center justify-between mb-2 hover:bg-gray-50 transition-colors duration-200"
                    >
                      <Dialog>
                        <DialogTrigger asChild>
                          <Button
                            variant="outline"
                            className="w-full justify-start mr-2 py-2 px-3 shadow-md hover:shadow-lg transition-shadow duration-200"
                          >
                            <div className="flex items-center w-full">
                              <FileText className="h-4 w-4 mr-2 flex-shrink-0" />
                              <div className="text-left flex-grow">
                        ...
                        <DialogContent>
                          ...
                          <div className="mt-2">
                            <p>{item.content}</p>
                            <div className="mt-4">
                              <strong>{translate("Date:", "Fecha:")}</strong>{" "}
                              {item.date}
                            </div>
                            <div>
                              <strong>{translate("Time:", "Hora:")}</strong>{" "}
                              {item.time}
                            </div>
                            <div className="mt-2">
                              <strong>
                                {translate("Tags:", "Etiquetas:")}
                              </strong>{" "}
                              {item.tags.join(", ")}
                            </div>
                          </div>
